...
def mutation_and_print_test():
  ...
  connect_genes[0, 1] = ConnectionGene(innov_n = 2, w_value = 2/10.0, disable= False)
  ...
  connect_genes[0, 3] = ConnectionGene(innov_n = 3, w_value = 3/10.0, disable= False)
  connect_genes[3, 1] = ConnectionGene(innov_n = 4, w_value = 4/10.0, disable= False)
  ...
  connect_genes[0, 5] = ConnectionGene(innov_n = 5, w_value = 5/10.0, disable= False)
  connect_genes[5, 3] = ConnectionGene(innov_n = 6, w_value = 6/10.0, disable= False)
...
# iter 7
  nodes_genes[8] = NodeGene(input_nodes = [3], output_nodes=[5], neuron_type = 'h')
  nodes_genes[3].output_nodes.append(8)
  nodes_genes[5].input_nodes.append(8)
  connect_genes[3, 8] = ConnectionGene(innov_n = 8, w_value = 8/10.0, disable= False)
  connect_genes[8, 5] = ConnectionGene(innov_n = 9, w_value = 9/10.0, disable= False)
